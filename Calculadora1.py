...
a    = Button(ventana, text = "<--", width = 5, height = 2,command = lambda: click_boton("a"))
MC   = Button(ventana, text = "MC" , width = 5, height = 2,command = lambda: borrar())
c    = Button(ventana, text = "C"  , width = 5, height = 2,command = lambda: click_boton("c"))
d    = Button(ventana, text = "±"  , width = 5, height = 2,command = lambda: click_boton("d"))
...
MR = Button(ventana, text = "MR" , width = 5, height = 2,command = lambda: MR1())
Mmas = Button(ventana, text = "M+" , width = 5, height = 2,command = lambda: MMAS())


g    = Button(ventana, text = "%"  , width = 5, height = 2,command = lambda: porciento())
...
h    = Button(ventana, text = "1/x", width = 5, height = 2,command = lambda: unoentrex())
...
sqr  = Button(ventana, text = "sqr", width = 5, height = 2,command = lambda: click_boton("sqr"))


MS = Button(ventana, text = "MS" , width = 5, height = 2,command = lambda: click_boton(")"))
decimal     = Button(ventana, text = "." , width = 5, height = 2,command = lambda: click_boton("."))
borrar1     = Button(ventana, text = "CE", width = 5, height = 2,command = lambda: borrar())
...
multi = Button(ventana, text = "*", width = 5, height = 2,command = lambda: click_boton("*"))
divi  = Button(ventana, text = "÷", width = 5, height = 2,command = lambda: click_boton("/"))
igual = Button(ventana, text = "=", width = 5, height = 6,command = lambda: operacion())
